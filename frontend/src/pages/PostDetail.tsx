...
const PostDetail: React.FC = () => {
  ...
  const confirmDeletePost = async () => {
    ...
    try {
      ...
      setErrorModal({ open: true, message: 'Failed to delete post' });
  ...
  const handleAddComment = async (data: { content: string }) => {
    ...
    try {
      ...
      setErrorModal({ open: true, message: 'Failed to add comment' });
    }
  };
  ...
  const confirmDeleteComment = async () => {
    ...
    try {
      ...
      setErrorModal({ open: true, message: 'Failed to delete comment' });
      setDeleteCommentId(null);
    } finally {
      setIsDeleting(false);
    }
